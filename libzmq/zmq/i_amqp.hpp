...
namespace zmq
{
    ...
    struct i_amqp
    {
        ...
        enum {
            ...
            basic_property_content_type = 32768,
            basic_property_content_encoding = 16384,
            basic_property_headers = 8192,
            basic_property_delivery_mode = 4096,
            basic_property_priority = 2048,
            basic_property_correlation_id = 1024,
            basic_property_reply_to = 512,
            basic_property_expiration = 256,
            basic_property_message_id = 128,
            basic_property_timestamp = 64,
            basic_property_type = 32,
            basic_property_user_id = 16,
            basic_property_app_id = 8,
            basic_property_reserved = 4,
            tx_select_id = 10,
            tx_select_ok_id = 11,
            tx_commit_id = 20,
            tx_commit_ok_id = 21,
