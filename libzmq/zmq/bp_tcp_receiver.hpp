...
#ifndef __ZMQ_BP_TCP_RECEIVER_HPP_INCLUDED__
#define __ZMQ_BP_TCP_RECEIVER_HPP_INCLUDED__
...
namespace zmq
{
    ...
    //  BP/TCP receiver is defined by the follwowing properties:
    //
    ...
    private:
        ...
        bp_tcp_receiver_t (i_demux *demux_, const char *hostname_,
            const char *local_object_, const char * /* options_*/);

        bp_tcp_receiver_t (i_demux *demux_,
        ...
        bp_tcp_receiver_t (const bp_tcp_receiver_t&);
        void operator = (const bp_tcp_receiver_t&);
    };
