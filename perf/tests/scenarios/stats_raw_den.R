...
density <- (data$V4 - data$V3) / data$V2
...
#  Save the results
data_frame <- data.frame (data$V1, data$V2, density, thrput_msg, thrput_bit)
write.table (data_frame, file = "density_agg.dat", col.names = FALSE, row.names = FALSE)
